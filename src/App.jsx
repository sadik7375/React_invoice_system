...
function App() {
  ...
  const [list, setlist] = useState(getdata(), [
    // Default row
    { id: 0, description: '', quantity: '', price: '', amount: 0 },
  ]);
        ...
        <>
          <div className="flex flex-col justify-center">
            ...
            <>
              ...
              <TableForm tax={tax} settax={settax} discount={discount} setdiscount={setdiscount} shippingcost={shippingcost} setshippingcost={setshippingcost} total={total} settotal={settotal} list={list} setlist={setlist} setdescription={setdescription} setquantity={setquantity} setprice={setprice} setamount={setamount} description={description} quantity={quantity} price={price} amount={amount} ></TableForm>
              ...
              <div className="flex flex-col">
                ...
                <textarea placeholder="Additional notes" value={notes} onChange={(e) => setnotes(e.target.value)} type='text' name='text' className='notes' autoComplete='off' />
              </div>
